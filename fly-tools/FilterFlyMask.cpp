...
int main(int argc, char* argv[])
{
  ...
  ColorMono bottomLeftColor = ColorMono(original->pixelColor(0,height-1));
    ...
    /*cout << topLeftColor.mono();
    cout << endl;
    cout << topRightColor.mono();
    cout << endl;
    cout << bottomRightColor.mono();
    cout << endl;
    cout << bottomLeftColor.mono();*/
    
    cout << bottomLeftColor << endl;
    cout << endl;
  ...
  for (int n=0; n<numberOfObjects; n++) {
    ...
    for (int i=0; i<totalPoints; i++) {
      ...
      cout << "image " << n << "done" << endl;

  }
    
    cout << "trying to write the image"  << endl;
